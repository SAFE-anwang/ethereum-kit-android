...
class TransactionSource(val name: String, val type: SourceType) {
    ...
    companion object {
        ...
        fun safeFourscan(apiKeys: List<String>): TransactionSource {
            return TransactionSource(
                    "safe4",
                    if (Chain.SafeFour.isSafe4TestNetId) {
                        SourceType.Etherscan("https://safe4testnet.anwang.com", "https://safe4testnet.anwang.com", apiKeys)
                    } else {
                        SourceType.Etherscan("https://safe4.anwang.com", "https://safe4.anwang.com", apiKeys)
                    }
